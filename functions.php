...
<html>
    ...
    <nav class="navtop">
    	<div>
    		...
    		<a href="readPizza.php"><i class="fas fa-shopping-basket"></i>Pizzas</a>
            <input type="text" placeholder="search" name="search" id="search"><i class="fa fa-search" aria-hidden="true"></i>
    	</div>
    </nav>
EOT;
}
