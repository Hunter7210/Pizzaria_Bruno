...
// Defina a variável $busca aqui
$busca = isset($_POST['search']) ? $_POST['search'] : '';

if (isset($_POST['submit'])) {
    // Preparar a instrução SQL e obter registros da tabela contacts, LIMIT irá determinar a página
    $stmt = $pdo->prepare("SELECT * FROM contatos WHERE nome LIKE :busca ORDER BY id_contato OFFSET :offset LIMIT :limit");
